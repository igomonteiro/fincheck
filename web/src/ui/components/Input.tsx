  ...
  ({ placeholder, name, id, error, className, ...props }, ref) => {
    ...
    return (
      <div className="relative">
        ...
        <label
          htmlFor={inputId}
          className="text-gray-7000 pointer-events-none absolute left-[13px] top-2 text-xs transition-all peer-placeholder-shown:top-3.5 peer-placeholder-shown:text-base"
        >
          {placeholder}
        </label>
        {error && (
